<div class="wrap">
    ...
    <div id="nav-menus-frame">
        ...
        <div id="menu-management-liquid">
            <?php do_action('daily-edition-manage-before', $edition_id, $edition_date, $posts) ?>
            ...
            <form method="post" action="edit.php?page=editions&amp;edition_id=<?php echo esc_attr($edition_id) ?>">
                ...
                <div class="tablenav bottom">
                    <div class="alignleft actions">
                        ...
                        <?php do_action('daily-edition-tablenav-published', $edition_id, $edition_date, $posts) ?>
                    </div>
                </div>
                <?php endif ?>
            </form>
            ...
            <?php do_action('daily-edition-manage-after', $edition_id, $edition_date, $posts) ?>
        </div>
    </div>
</div>
